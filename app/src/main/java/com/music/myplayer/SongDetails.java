...
public class SongDetails implements Parcelable {
    ...
    @ColumnInfo(name = "festivalDrawable")
    int festiwalDrawable;
    ...
    public int getFestiwalDrawable() {
        return festiwalDrawable;
    }

    public void setFestiwalDrawable(int festiwalDrawable) {
        this.festiwalDrawable = festiwalDrawable;
    }
